...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <h1 class="text-center mb-4">{{ trans('backpack::base.register') }}</h1>
            <div class="card">
                <div class="card-body">
                    <form class="col-md-12 p-t-10 form-padding" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            <label class="control-label" for="{{ backpack_authentication_column() }}">{{ trans('backpack::base.email_address') }}</label>
                        ...
                        <div class="form-group">
                            <div class="center-button">
                                <button type="submit" class="lp-button">
                                    ...
                                    <span>{{ trans('backpack::base.register') }}</span>
                                </button>
                            </div>
                        </div>
                    </form>
