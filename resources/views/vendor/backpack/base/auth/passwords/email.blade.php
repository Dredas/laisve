@extends(backpack_view('layouts.guest'))

<!-- Main Content -->
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-9 col-lg-6">
            <h1 class="text-center mb-4">{{ trans('backpack::base.reset_password') }}</h1>
            <div class="nav-steps-wrapper">
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item"><a class="nav-link disabled"><strong>{{ trans('backpack::base.step') }} 2.</strong> {{ trans('backpack::base.choose_new_password') }}</a></li>
                </ul>
            </div>
            <div class="nav-tabs-custom">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    @else
                    <form class="col-md-12 p-t-10 form-padding" role="form" method="POST" action="{{ route('backpack.auth.password.email') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group mb-3">
                            <div class="center-button">
                                <button type="submit" class="lp-button">
                                    ...
                                    <span>{{ trans('backpack::base.send_reset_link') }}</span>
                                </button>
                            </div>
                        </div>
                    </form>
