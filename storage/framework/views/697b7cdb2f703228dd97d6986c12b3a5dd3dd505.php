<div class="navbar-custom-menu pull-left">
    <ul class="nav navbar-nav">
        ...
        <?php if(backpack_auth()->check()): ?>
            ...
            <?php echo $__env->make('backpack::inc.topbar_left_content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    ...
    <ul class="nav navbar-nav">
        ...
        <?php if(config('backpack.base.setup_auth_routes')): ?>
            ...
            <?php else: ?>
                ...
                <?php echo $__env->make('backpack::inc.topbar_right_content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/dredas/lp/web/lp/resources/views/vendor/backpack/base/inc/menu.blade.php ENDPATH**/ ?>