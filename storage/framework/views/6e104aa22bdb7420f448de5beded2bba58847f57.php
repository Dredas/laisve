...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12 col-md-9 col-lg-6">
            <h1 class="text-center mb-4"><?php echo e(trans('backpack::base.reset_password')); ?></h1>
            <div class="nav-steps-wrapper">
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item"><a class="nav-link disabled"><strong><?php echo e(trans('backpack::base.step')); ?> 2.</strong> <?php echo e(trans('backpack::base.choose_new_password')); ?></a></li>
                </ul>
            </div>
            <div class="nav-tabs-custom">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <?php else: ?>
                    <form class="col-md-12 p-t-10 form-padding" role="form" method="POST" action="<?php echo e(route('backpack.auth.password.email')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-3">
                            <div class="center-button">
                                <button type="submit" class="lp-button">
                                    ...
                                    <span><?php echo e(trans('backpack::base.send_reset_link')); ?></span>
                                </button>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make(backpack_view('layouts.guest'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dredas/lp/web/lp/resources/views/vendor/backpack/base/auth/passwords/email.blade.php ENDPATH**/ ?>