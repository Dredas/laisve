<?php if($crud->exportButtons()): ?>
  ...
  <script>
    crud.dataTableConfiguration.buttons = [
        {
            extend: 'collection',
            text: '<i class="fa fa-download"></i> <?php echo e(trans('backpack::crud.export.export')); ?>',
            dropup: true,
            buttons: [
                {
                    name: 'copyHtml5',
        ...
        {
            extend: 'colvis',
            text: '<i class="fa fa-eye-slash"></i> <?php echo e(trans('backpack::crud.export.column_visibility')); ?>',
            columns: function ( idx, data, node ) {
...
<?php endif; ?>
<?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/crud/src/resources/views/crud/inc/export_buttons.blade.php ENDPATH**/ ?>