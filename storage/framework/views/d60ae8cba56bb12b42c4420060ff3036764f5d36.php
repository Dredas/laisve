  ...
  <script>
    <?php if($crud->getPersistentTable()): ?>
        ...
        var saved_list_url = localStorage.getItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url');
    ...
    <?php if($crud->getPersistentTableDuration()): ?>
        var saved_list_url_time = localStorage.getItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url_time');
    ...
    var crud = {
      ...
      updateUrl : function (new_url) {
        ...
        localStorage.setItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url', new_url);
      },
      dataTableConfiguration: {
        ...
        */
        ...
        stateSaveParams: function(settings, data) {
            ...
            localStorage.setItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url_time', data.time);
        ...
        stateLoadParams: function(settings, data) {
            ...
            if($saved_time < $current_date) {
                if (localStorage.getItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url')) {
                    localStorage.removeItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url');
                }
                if (localStorage.getItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url_time')) {
                    localStorage.removeItem('<?php echo e(str_slug($crud->getRoute())); ?>_list_url_time');
                }
               return false;
            }
        },
        ...
        language: {
              ...
              "search":         "<span class='d-none d-sm-inline'><?php echo e(trans('backpack::crud.search')); ?></span>",
...
<?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/crud/src/resources/views/crud/inc/datatables_logic.blade.php ENDPATH**/ ?>