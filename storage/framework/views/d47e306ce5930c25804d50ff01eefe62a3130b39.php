            ...
            <form class="form" action="<?php echo e(route('backpack.account.info')); ?>" method="post">
                ...
                <div class="card padding-10">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(backpack_url()); ?>" class="btn"><span class="ladda-label"><?php echo e(trans('backpack::base.cancel')); ?></span></a>
                    </div>
                </div>
...
<?php echo $__env->make('backpack::layouts.top_left', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/base/src/resources/views/my_account.blade.php ENDPATH**/ ?>