            ...
            <form class="form" action="<?php echo e(route('backpack.account.info.store')); ?>" method="post">
                ...
                <div class="card padding-10">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> <?php echo e(trans('backpack::base.save')); ?></button>
        ...
        <div class="col-lg-8">
            <form class="form" action="<?php echo e(route('backpack.account.password')); ?>" method="post">
                ...
                <div class="card padding-10">
                    ...
                    <div class="card-footer">
                            <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> <?php echo e(trans('backpack::base.change_password')); ?></button>
                            <a href="<?php echo e(backpack_url()); ?>" class="btn"><?php echo e(trans('backpack::base.cancel')); ?></a>
                    </div>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/crud/src/resources/views/base/my_account.blade.php ENDPATH**/ ?>