<nav class="navbar navbar-expand-lg navbar-filters mb-0 pb-0 pt-0">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#bp-filters-navbar" aria-controls="bp-filters-navbar" aria-expanded="false" aria-label="<?php echo e(trans('backpack::crud.toggle_filters')); ?>">
        <span class="fa fa-filter"></span> <?php echo e(trans('backpack::crud.filters')); ?>
      ...
      <div class="collapse navbar-collapse" id="bp-filters-navbar">
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item"><a href="#" id="remove_filters_button" class="nav-link <?php echo e(count(Request::input()) != 0 ? '' : 'invisible'); ?>"><i class="fa fa-eraser"></i> <?php echo e(trans('backpack::crud.remove_filters')); ?></a></li>
        </ul>
      </div><!-- /.navbar-collapse -->
  </nav>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/crud/src/resources/views/crud/inc/filters_navbar.blade.php ENDPATH**/ ?>