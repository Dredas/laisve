...
<ul class="nav navbar-nav ml-auto">
    ...
    <?php if(config('backpack.base.setup_auth_routes')): ?>
        <?php if(backpack_auth()->guest()): ?>
            <li class="nav-item"><a class="nav-link" href="<?php echo e(url(config('backpack.base.route_prefix', 'admin').'/login')); ?>"><?php echo e(trans('backpack::base.login')); ?></a>
            </li>
...
<?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/base/src/resources/views/inc/menu.blade.php ENDPATH**/ ?>