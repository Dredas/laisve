<header class="<?php echo e(config('backpack.base.header_class')); ?>">
  ...
  <a class="navbar-brand" href="<?php echo e(url(config('backpack.base.home_link'))); ?>">
      <img src="https://www.laisvespartija.lt/wp-content/themes/lp-wp/assets/images/logo-white.svg" height="40">
  </a>
...
<?php /**PATH /home/dredas/lp/web/lp/resources/views/vendor/backpack/base/inc/main_header.blade.php ENDPATH**/ ?>