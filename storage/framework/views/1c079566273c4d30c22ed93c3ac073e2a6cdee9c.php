<?php if($crud->hasAccess('update')): ?>
	...
	<!-- Single edit button -->
	<a href="<?php echo e(url($crud->route.'/'.$entry->getKey().'/edit')); ?>" class="btn btn-sm btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('backpack::crud.edit')); ?></a>

	<?php else: ?>

	<!-- Edit button group -->
	<div class="btn-group">
	  <a href="<?php echo e(url($crud->route.'/'.$entry->getKey().'/edit')); ?>" class="btn btn-sm btn-link pr-0"><i class="fa fa-edit"></i> <?php echo e(trans('backpack::crud.edit')); ?></a>
	...
	<?php endif; ?>
<?php endif; ?><?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/crud/src/resources/views/crud/buttons/update.blade.php ENDPATH**/ ?>