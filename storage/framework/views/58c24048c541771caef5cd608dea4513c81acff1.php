<div class="<?php echo e($widget['wrapperClass'] ?? 'col-sm-6 col-lg-3'); ?>">
  <div class="<?php echo e($widget['class'] ?? 'card'); ?>">
    ...
    <div class="card-footer px-3 py-2">
      <a class="btn-block text-muted d-flex justify-content-between align-items-center" href="<?php echo e($widget['footer_link'] ?? '#'); ?>"><span class="small font-weight-bold"><?php echo e($widget['footer_text'] ?? 'View more'); ?></span><i class="fa fa-angle-right"></i></a>
    </div>
    <?php endif; ?>
  </div>
</div><?php /**PATH /home/dredas/lp/web/lp/vendor/backpack/crud/src/resources/views/base/widgets/progress_white.blade.php ENDPATH**/ ?>